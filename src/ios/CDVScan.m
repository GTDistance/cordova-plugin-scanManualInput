...
- (void)recognize:(CDVInvokedUrlCommand*)command{
    ...
    //    [navController.navigationBar setBarTintColor:[UIColor colorWithRed:43/255.f green:173/255.f blue:222/255.f alpha:0.0]];
    ...
    //导航栏透明
    [[[navController.navigationBar subviews]objectAtIndex:0] setAlpha:0];
